  ...
  return (
    <header className="bg-white body-font border-b text-gray-900  shadow-xl">
      <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        ...
        <Link to="/dashboard  " className="inline-flex items-center bg-gray-200 border-0 py-1 px-3 focus:outline-none hover:bg-indigo-500 hover:text-white rounded text-base mt-4 md:mt-0">Dashboard {rightArrow}</Link>
      </div>
    </header>
  )
}
